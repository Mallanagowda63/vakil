...
String? _sessionToken() => AuthService.instance.token;
...
class CallSession extends ChangeNotifier {
  CallSession({required this.callId, required this.requestId, required this.otherName, this.otherPhotoUrl, required this.outgoing, required this._phase});
  final String callId;
