        ...
        body: SafeArea(
          child: Padding(
            ...
            child: Column(children: [
              ...
              // The last minute: the call ends with the chat unless time is added.
              if (!ended && left != null && left <= 60) ...[
                const SizedBox(height: 14),
                const Text('Less than 1 minute left', style: TextStyle(color: Color(0xFFFCA5A5), fontSize: 13)),
                const SizedBox(height: 8),
                FilledButton.icon(
                  onPressed: () => showAddTimeSheet(context, requestId: _call.requestId),
